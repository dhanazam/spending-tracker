...
import 'package:spendingtracker/core/extensions/datetime_extension.dart';
import 'package:spendingtracker/core/extensions/string_extension.dart';
...
class CategoryItem extends StatelessWidget {
  ...
  void changeDateDialog(
      BuildContext context, DateTime date, Function setNewDate) {
    final colorTheme = Theme.of(context).extension<ColorThemeExtension>()!;
    String formattedDate =
        '${date.day} ${AppLocalizations.of(context)!.short_month('month_${date.month}')} ${date.year}';
